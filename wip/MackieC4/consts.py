...
SETUP_DB_MAX_DEVICE_BANKS = 128  # script allows as many device banks as Live allows (is 1024 max devices enough?)
...
SETUP_DB_MAX_PARAM_BANKS = 64  # script allows as many parameter banks as Live allows (is 1456 max parameters enough?)
