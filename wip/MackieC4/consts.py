...
SETUP_DB_MAX_DEVICE_BANKS = 32

# max 256 devices per track in 16 banks of 8 encoders/devices
...
SETUP_DB_MAX_PARAM_BANKS = 12

# max 288 parameters per device in 5 banks of 24 encoders/parameters
