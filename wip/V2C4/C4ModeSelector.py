    ...
    def update(self):
        ...
        if self.is_enabled():
            if self._mode_index == 0:
                ...
                if len(self._encoder_row00_displays) == 2 and \
